...
contract RealEstate {
    ...
    //REVIEWSection - keep them in a struct to check how many reciews are per property
    ...
    //FUNCTIONS IN CONTRACTS

    function listProperty(
        address owner, uint256 price, string memory _propertyTitle, string memory _category, 
    ...
    function updateProperty(
        address owner, uint256 productId, string memory _propertyTitle, string memory _category,
         string memory _images, string memory _propertyAddress, string memory _description
        ) external returns (uint256) {
    ...
    function getProperty(uint256 id) external view returns(uint256, address, uint256, string memory, string memory,
    ...
    function addReview(uint256 productId, uint256 rating, string calldata comment, address user) external{
        ...
        require(rating >= 1 && rating <= 5, "Rating has to be between 1 and 5");
